    ...
    <>
      <section className="section-padding section-spacing pt-28 md:pt-36">
        <div className="max-w-3xl mx-auto prose-legal space-y-12">
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">1. Payment</h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>1.1</strong> All tours will be booked and confirmed only
              ...
              <p>
                <strong>1.2</strong> The payment balance is due no later than 42
                days prior to the safari, unless agreed otherwise.
              </p>
              <p>
                <strong>1.3</strong> Bookings made within 42 days before arrival
                must be paid in full at the time of confirmation.
              </p>
              <p>
                <strong>1.4</strong> If payment is not received in accordance with
          ...
          <section>
            ...
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>2.1</strong> All cancellation requests must be made in
                writing and shall be effective on the date of actual receipt by
                Kitum Cave Safaris.
              </p>
              <p>
                <strong>2.2</strong> The following cancellation charges apply to
              ...
              <p>
                <strong>2.3</strong> Gorilla permits and air tickets are 100%
                non-refundable.
              </p>
              <p>
                <strong>2.4</strong> No refunds will be made for any unused
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">3. Prices</h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>3.1</strong> The prices quoted for the various safaris are
              ...
              <p>
                <strong>3.2</strong> Expenses that are not covered: international
              ...
              <p>
                <strong>3.3</strong> Prices on the website or quoted to our
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">4. Bookings</h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>4.1</strong> Kitum Cave Safaris Limited provides
                transportation, accommodation bookings, restaurant meals,
                excursions, and other services in cooperation with independent
                suppliers.
              </p>
              <p>
                <strong>4.2</strong> All information detailed in client
              ...
              <p>
                <strong>4.3</strong> To reserve flights and gorilla permits we
                need: your full names as they appear in your passport, your
                nationality, and passport number.
              </p>
              <p>
                <strong>4.4</strong> Before confirming a safari, the client must
              ...
              <p>
                <strong>4.5</strong> All packages are subject to availability and
              ...
              <p>
                <strong>4.6</strong> In the event that you wish to amend your
              ...
              <p>
                <strong>4.7</strong> Kitum Cave Safaris reserves the right to
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">
              5. Execution of the Tour
            </h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>5.1</strong> It is a privilege to see animals in their
              ...
              <p>
                <strong>5.2</strong> A gorilla or chimpanzee permit guarantees
                clients will be able to track the primates in question but does
                not guarantee that the animals will be in plain sight.
              </p>
              <p>
                <strong>5.3</strong> Accommodation is based on a twin or double
              ...
              <p>
                <strong>5.4</strong> Kitum Cave Safaris reserves the right to
              ...
              <p>
                <strong>5.5</strong> The mode of transport used will be dependent
              ...
              <p>
                <strong>5.6</strong> Experienced English-speaking driver/guides
              ...
              <p>
                <strong>5.7</strong> Kitum Cave Safaris reserves the right to
              ...
              <p>
                <strong>5.8</strong> Kitum Cave Safaris reserves the right to
                employ subcontractors to carry out all or part of the services
                agreed to be supplied.
              </p>
              <p>
                <strong>5.9</strong> Kitum Cave Safaris reserves the right to
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">6. Liability</h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>6.1</strong> Kitum Cave Safaris will make every effort to
              ...
              <p>
                <strong>6.5</strong> It is the responsibility of the travel
              ...
              <p>
                <strong>6.8</strong> The respective laws of Uganda govern Kitum
          ...
          <section>
            <h2 className="heading-sub text-brand-forest mb-4">7. Complaints</h2>
            <div className="space-y-4 body-text text-sm">
              <p>
                <strong>7.1</strong> Kitum Cave Safaris shall try to ensure that
              ...
              <p>
                <strong>7.2</strong> Complaints must be reported immediately to
              ...
              <p>
                <strong>7.3</strong> Liability for any complaints not notified in
